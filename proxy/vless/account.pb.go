...
type Account struct {
	...
	Flow string `protobuf:"bytes,2,opt,name=flow,proto3" json:"flow,omitzero"`
	// Encryption settings. Only applies to client side, and only accepts "none" for now.
	Encryption string `protobuf:"bytes,3,opt,name=encryption,proto3" json:"encryption,omitzero"`
}
